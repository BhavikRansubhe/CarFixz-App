...
import com.br14x.carfixz.adapters.ShopListAdapter;
import com.br14x.carfixz.databinding.FragmentShopBinding;
    ...
    public void addItem(Product product) {
        ...
        if(isAdded) {
            ...
            .show();
                ...
                Snackbar.make(requireView(),"Already have max quantity in cart !!",Snackbar.LENGTH_LONG).show();
            }

    }

    @Override
    public void onItemClick(Product product) {                                //item click function in shop fragment

        shopViewModel.setProduct(product);                                   //shop view model has this method to set product into view
        navController.navigate(R.id.action_shopFragment_to_productDetailsFragment);      //used for navigation
    }
}
