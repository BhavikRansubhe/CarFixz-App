...
public class SaiSerViceCenterApptBooking_1 extends SaiSerViceCenterApptBooking implements  DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sai_ser_vice_center_appt_booking_1);
        selectDate = findViewById(R.id.selectDateButtonSai);
        selectTime = findViewById(R.id.timeSpinnerSai);
        bookButton = (Button) findViewById(R.id.bookApptButtonSai);
        ...
        final LoadingDialog loadingDialog=new LoadingDialog(SaiSerViceCenterApptBooking_1.this);
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent=new Intent(SaiSerViceCenterApptBooking_1.this, Appt_Booking_final.class);
                        intent.putExtra("garageName","Sai Service Center");
                        intent.putExtra("BookingID",SaiSerViceCenterApptBooking.bid);
    ...
    public void writeNewBooking(){
        ...
        ApptInfo appt=new ApptInfo(SaiSerViceCenterApptBooking.bid,owner_name,owner_contact,car_reg_no,car_brand,car_model,timeSelected,date,"Sai Service",sugg);
        MainActivity.apptinfo.add(appt);
        mDatabase.child("Bookings").child("Sai Service Center").child(SaiSerViceCenterApptBooking.bid).setValue(appt);
    }
