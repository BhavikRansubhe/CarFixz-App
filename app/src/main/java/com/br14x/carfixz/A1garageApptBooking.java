...
public class A1garageApptBooking extends AppCompatActivity implements AdapterView.OnItemSelectedListener  {

    protected static String ownername;
    protected static String ownercontact;
    protected static String regno;
    protected static String vehicle_brand;
    protected static String vehicle_model;
    protected static String bid;
   // private DatabaseReference mDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a1garage_appt_booking);
        ...
        book_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (customer_name.getText().toString().isEmpty()) {
                    Toast.makeText(A1garageApptBooking.this, "Enter a Customer name!!!", Toast.LENGTH_SHORT).show();
                    customer_name.requestFocus();
                }
                else if (veh_reg_no.getText().toString().isEmpty()) {
                    Toast.makeText(A1garageApptBooking.this, "Enter a registration number!!!", Toast.LENGTH_SHORT).show();
                    veh_reg_no.requestFocus();
                }
                else if (customer_contact.getText().toString().isEmpty()) {
                    Toast.makeText(A1garageApptBooking.this, "Enter a Contact Number!!!", Toast.LENGTH_SHORT).show();
                    customer_contact.requestFocus();
                }
                else if(customer_contact.getText().toString().length()!=10){
                    Toast.makeText(A1garageApptBooking.this, "Enter a Valid 10-digit Contact Number!!!", Toast.LENGTH_SHORT).show();
                    customer_contact.requestFocus();
                }
                else {
                    ...
                    startActivity(new Intent(A1garageApptBooking.this,A1garageApptBooking_1.class));
                    overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                    brand.setPrompt("Select Vehicle brand");
                    cars.setPrompt("Select Model");
                }
            }
        });
