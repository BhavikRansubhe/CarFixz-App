package com.br14x.carfixz.adapters;
...
import com.br14x.carfixz.databinding.CartRowBinding;
...
public class CartListAdapter extends ListAdapter<CartItem, CartListAdapter.CartVH > {
    ...
    public interface CartInterface{         //This will be implemented in cart fragment
