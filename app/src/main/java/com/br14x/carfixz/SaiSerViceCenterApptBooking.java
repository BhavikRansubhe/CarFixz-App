...
public class SaiSerViceCenterApptBooking extends AppCompatActivity implements AdapterView.OnItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sai_ser_vice_center_appt_booking);
        ...
        book_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (customer_name.getText().toString().isEmpty()) {
                    Toast.makeText(SaiSerViceCenterApptBooking.this, "Enter a Customer name!!!", Toast.LENGTH_SHORT).show();
                    customer_name.requestFocus();
                }
                else if (veh_reg_no.getText().toString().isEmpty()) {
                    Toast.makeText(SaiSerViceCenterApptBooking.this, "Enter a registration number!!!", Toast.LENGTH_SHORT).show();
                    veh_reg_no.requestFocus();
                }
                else if (customer_contact.getText().toString().isEmpty()) {
                    Toast.makeText(SaiSerViceCenterApptBooking.this, "Enter a Contact Number!!!", Toast.LENGTH_SHORT).show();
                    customer_contact.requestFocus();
                }
                else if(customer_contact.getText().toString().length()!=10){
                    Toast.makeText(SaiSerViceCenterApptBooking.this, "Enter a valid 10-digit Contact Number!!!", Toast.LENGTH_SHORT).show();
                    customer_contact.requestFocus();
                }
                else {
                    ...
                    startActivity(new Intent(SaiSerViceCenterApptBooking.this,SaiSerViceCenterApptBooking_1.class));
